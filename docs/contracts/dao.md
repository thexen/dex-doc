    ...
    * **invokeEditProbabilityTable**   
    ...
    ```   
        ...
        **확률 테이블**   
        ...
        | *Tier*      | *확률(1/1,000,000)*  | *확률조정범위* | *가중치* | *가중조정범위* | *인센티브* |
        | :--------- | --------------: | :-----------------: | -------------: | :-------------: | -------------: |
        | SSSP | 43 |   불가 | 100 | 불가 | 50% |
        | SSS | 3,190 |  500~5,000 | 50 | 39~57 | 9% |      
        | SS | 43,000 |  2,000~60,0000 | 25 | 24~27 | 1% |     
        | S | 130,000 |  100,000~150,000 | 20 | 18~22 | - |     
        | A | 300,000 |  300,000~400,000 | 15 | 13~17 | - |     
        | B | 500,000 |  불가 | 12 | 불가 | -  |     
        | C | 1,000,000 | 불가 | 10 | 불가 | - |       
